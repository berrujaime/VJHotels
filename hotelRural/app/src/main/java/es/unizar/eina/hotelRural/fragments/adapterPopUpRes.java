...
public class adapterPopUpRes extends AppCompatActivity {
    ...
    public static class BorrarDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            builder.setView(inflater.inflate(R.layout.popup_borrarres, null))
                    // Add action buttons
                    .setPositiveButton(R.string.eliminar, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int id) {

                            mDbHelper.deleteRes(idHab);
                            Intent i = new Intent(getActivity(), ReservasList.class);
                            startActivity(i);
                            Context context = getContext().getApplicationContext();
                            CharSequence text = "Reserva borrada" ;
